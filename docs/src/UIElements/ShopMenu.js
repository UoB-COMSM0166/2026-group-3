...
export class ShopMenu extends Menu {
    constructor(game, scene){
        super(game, new Vector2(280,200), new Vector2("Left","Top"))
        this.scene = scene;
        ...
        let shopTitle = new Label(game, "WEAPON SHOP", new Vector2(this.size.x, 30), new Vector2("Left", "Top"));
        ...
        for (let i=0; i<shopWeapons.length; i++){
            ...
            let weaponLabel = new Label(game, weapon.name, new Vector2(150, 30), new Vector2("Left", "Top"));
            ...
            let weaponPrice = new Button(game, str(weapon.price)+"🪙", new Vector2(80, 30), new Vector2("Left", "Top"));
        ...
        let turretLabel = new Label(game, "Turret", new Vector2(150, 30), new Vector2("Left", "Top"));
        ...
        let turretPrice = new Button(game, str(scene.turretManager.turretPrice)+"🪙", new Vector2(80, 30), new Vector2("Left", "Top"));
