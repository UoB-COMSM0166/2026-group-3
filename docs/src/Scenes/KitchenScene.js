...
export class KitchenScene extends Scene {
  constructor(game) {
    ...
    console.log("KitchenScene loaded");
    ...
    // Player
    this.player = new PlayerChef(game);
...
const stationGap = 1.25;
    ...
    for (let i = 0; i < 5; i++) {
      ...
      const station = new KitchenStation(game, pos, stationTypes[i]);
    ...
    // Counter
    this.counter = new Counter(game, new Vector2(3.2, 2.65));
  ...
  async update(events) {
    ...
    for (let entity of this.entities) {
      if (entity instanceof Customer && this.phase === "PLANNING") {
        continue;
      }
